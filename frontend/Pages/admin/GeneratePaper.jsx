    ...
    <>
      ...
      <div className="app-container">
        ...
        <div className="main-content">
          ...
          {/* Board Selection */}
     { currentStep===1 &&<div className="board-selection">
         ...
         {currentStep===1 && <div className="form-container">
         ...
         {currentStep===2 && <div className="form-container">
            <div className="form-group">
        ...
        { currentStep===3 && <div className="form-container">
            <div className="form-group">
          ...
          {/* Back Button */}
          {currentStep !== 1 && (<div className="button-container">
            <button
          ...
          {/* Continue Button */}
          {currentStep !== 3 && (<div className="button-container">
            <button
              className="continue-button"
              onClick={() => {
