export const menuItems = [
    { name: 'My Dashboard', path: '/my-dashboard', icon: '🏠', isNew: false },
    { name: 'Generate Paper', path: '/generate-paper', icon: '📝', isNew: false },
    { name: 'Purchase Package', path: '/purchase-package', icon: '🛒', isNew: false },
    { name: 'My Papers', path: '/my-papers', icon: '📄', isNew: false },
    { name: 'Generate Worksheet', path: '/generate-worksheet', icon: '📋', isNew: false },
